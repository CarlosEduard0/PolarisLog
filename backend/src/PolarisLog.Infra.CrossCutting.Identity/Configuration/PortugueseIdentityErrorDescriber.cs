...
namespace PolarisLog.Infra.CrossCutting.Identity.Configuration
{
    public class PortugueseIdentityErrorDescriber : IdentityErrorDescriber
    {
        ...
        {
            return new IdentityError
                {Code = nameof(LoginAlreadyAssociated), Description = "Já existe um usuário com este email."};
        }
        ...
        public override IdentityError InvalidUserName(string userName)
        {
            return new IdentityError
            {
                ...
                Description = $"Email '{userName}' é inválido, pode conter apenas letras ou dígitos."
            };
        }
        ...
        {
            return new IdentityError
                {Code = nameof(DuplicateUserName), Description = $"Email '{userName}' já está sendo utilizado."};
        }
